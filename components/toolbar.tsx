    ...
    <div className="pl-[54px] group relative">
      {!!initialData.icon && !preview && (
        <div className="flex items-center gap-x-2 group/icon pt-6">
          ...
          <Button onClick={onRemoveIcon} className="rounded-full opacity-0 group-hover/icon:opacity-100 text-muted-foreground text-xs" variant={"outline"} size={"icon"}>
            <X className="h-4 w-4 " />
          </Button>
        </div>
      )}
      ...
      <div className="opacity-0 group-hover:opacity-100 flex items-center ga-x-1 py-4">
        {!initialData.icon && !preview && (
        ...
        {!initialData.coverImage && !preview && (
          <Button 
          onClick={coverImage.onOpen} size={"sm"} className="text-muted-foreground text-xs" variant={"outline"}>
